...
<head>
    ...
    <title>PHP CRUD Operation Using Google Firebase - NiceSnippets.com</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="container" style="margin-top: 50px;">
        <h4 class="text-center">PHP CRUD Operation Using Google Firebase - NiceSnippets.com</h4><br>
        <h5>Add User</h5>
